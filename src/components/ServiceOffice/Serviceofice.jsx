  ...
  return (
    <div className="Service_Office_Container">
      ...
      <div className="subhead">
        <p>
          Our serviced office packages enable you to easily and quickly lease an
          office in any of our locations throughout the world and support your
          business to expand into other markets
        </p>
      </div>
      <div className="parts">
        <div className="world">
      ...
      <button className="serviceButton">See more details</button>
    </div>
  );
};
